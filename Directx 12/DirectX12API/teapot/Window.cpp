...
Window::Window(LONG width, LONG height, LPCWSTR title)
{
	WNDCLASSEX wcex;
	...
	hWnd = CreateWindowEx(0, L"WindowClass", title, WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, 0, rect.right - rect.left, rect.bottom - rect.top, nullptr, nullptr, nullptr, this);
	if (!hWnd)
	{
