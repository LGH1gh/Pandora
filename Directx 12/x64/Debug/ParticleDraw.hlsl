...
// cbuffer cb1
// {
// 	static float g_fParticleRad = 10.f;
// };
...
// 	output.color = lerp(float4(1.f, 0.1f, 0.1f, 1, f), input.color, mag);
...
// 	for (int i = 0; i < 4; ++i)
// 	{
// 		float3 position = g_position[i] * g_fParticleRad;
...
// 	intensity = clamp(intensity, 0.f, 0.5f) * 2.f;
